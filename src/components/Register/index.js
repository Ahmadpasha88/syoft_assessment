  ...
  if (isLogedIn) {
    ...
    const validateMail =()=>{
        ...
        if (!mail) {
            ...
            newErrors.mail =  "Email should have a valid domain (.com, .net, .org, .edu).";
    ...
    const validatePhone=()=>{
        if (!phone) {
            ...
            newErrors.phone = "Phone number should not contain '+' or '.' characters.";
        }
                    ...
                    <div className='row'>
                        ...
                        <div className='mb-3'>
                            <p className='text-center fw-bold'>
                                ...
                                <Link to='/login' className='text-primary text-decoration-underline' role='button'>
                                    go to login
                                </Link>
                            </p>
                        </div>
